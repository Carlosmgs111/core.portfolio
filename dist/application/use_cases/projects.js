...
exports.migrateDescriptionToDescriptions = exports.updateProject = exports.deleteProject = exports.addProject = exports.getOwnProjects = exports.getProjects = void 0;
...
const migrateDescriptionToDescriptions = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const projects = yield dependencies_1.DatabaseService.command
        .setupEntity("Project")
        .findAll();
