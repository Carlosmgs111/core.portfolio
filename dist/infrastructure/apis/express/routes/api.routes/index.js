...
const express_auth_routes_1 = __importDefault(require("../../../../../modules/users/routes/express.auth.routes"));
const express_routes_4 = __importDefault(require("../../../../../modules/posts/routes/express.routes"));
const express_routes_5 = __importDefault(require("../../../../../modules/skills/routes/express.routes"));
const express_routes_6 = __importDefault(require("../../../../../modules/notes/routes/express.routes"));
...
exports.default = router
    ...
    .use("/posts", express_routes_4.default)
    .use("/skills", express_routes_5.default)
    .use("/notes", express_routes_6.default)
    .use("", express_auth_routes_1.default);
