...
class CQRSService {
    constructor() {
        ...
        this.findOne = (entity_1, ...args_1) => __awaiter(this, [entity_1, ...args_1], void 0, function* (entity, options = {}) {
            return yield this.QueryService.findOne(entity, options);
        });
        this.findAll = (entity_1, ...args_1) => __awaiter(this, [entity_1, ...args_1], void 0, function* (entity, options = {}) { return yield this.QueryService.findAll(entity, options); });
