...
class TaskMessageService {
    constructor() {
        ...
        this.publish = (payload_1, ...args_1) => __awaiter(this, [payload_1, ...args_1], void 0, function* (payload, receiverFunc = undefined, conf = { type: TYPE }) {
            const { type } = conf;
        ...
        this.subscribe = (payload_1, ...args_1) => __awaiter(this, [payload_1, ...args_1], void 0, function* (payload, type = TYPE) {
            const [exchangeName, _payload] = (0, utils_1.Mapfy)(payload).entries().next().value;
