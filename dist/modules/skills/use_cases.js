...
const getSkillByUUID = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return yield entity_1.Skill.find(dependencies_1.RepositoryService, data);
});
exports.getSkillByUUID = getSkillByUUID;
const addNewSkill = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return yield entity_1.Skill.create(dependencies_1.RepositoryService, data);
});
exports.addNewSkill = addNewSkill;
const addManySkills = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { skills, user } = data;
    const newSkills = yield entity_1.Skill.createMany(dependencies_1.RepositoryService, skills.map((c) => (Object.assign(Object.assign({}, c), { user }))));
...
const updateSkill = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield (yield entity_1.Skill.load(dependencies_1.RepositoryService, { credentials: { uuid } })).update(dependencies_1.RepositoryService, data);
