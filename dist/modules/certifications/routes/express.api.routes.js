...
exports.default = router
    .post("/", (0, validator_handler_1.validatorHandler)(certification_schema_1.createCertification, "body"), (0, express_2.expressHandlerAdapter)(use_cases_1.addNewCertification))
    .post("/certifications", 
...
(0, express_2.expressHandlerAdapter)(use_cases_1.addManyCertifications))
    ...
    .delete("/", (0, express_2.expressHandlerAdapter)(use_cases_1.removeCertification))
    .delete("/:uuid", (0, express_2.expressHandlerAdapter)(use_cases_1.removeCertification))
    .patch("/", (0, validator_handler_1.validatorHandler)(certification_schema_1.updateCertification, "body"), (0, express_2.expressHandlerAdapter)(use_cases_1.updateCertification));
