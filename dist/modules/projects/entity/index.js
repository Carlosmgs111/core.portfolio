...
class Project {
    constructor({ uuid, User, name, descriptions, images, tags, stack, state, kind, uri, version, }) {
        this.createdAt = 0;
        this.updatedAt = 0;
        this.remove = (RepositoryService_1, ...args_1) => __awaiter(this, [RepositoryService_1, ...args_1], void 0, function* (RepositoryService, options = {}) {
            ...
            if (!removed)
                return;
            return yield RepositoryService.removeOne(RepositoryService.QueryService.entities.Project, {
                indexation: { uuid },
            });
        });
        this.update = (RepositoryService, data) => __awaiter(this, void 0, void 0, function* () {
            this.updatedAt = new Date().getTime();
            return yield RepositoryService.updateOne(RepositoryService.QueryService.entities.Project, Object.assign({ updatedAt: this.updatedAt }, (0, utils_1.filterAttrs)(data, ["uuid", "user", "token"])), { indexation: { uuid: this.uuid } });
        });
        this.uuid = uuid;
        this.User = User;
        this.name = name;
...
Project.new = (RepositoryService, data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newProject = yield RepositoryService.createOne(RepositoryService.QueryService.entities.Project, new _a(Object.assign(Object.assign({}, data), { uuid })));
...
Project.createMany = (RepositoryService, data) => __awaiter(void 0, void 0, void 0, function* () {
    const projectsCreated = yield RepositoryService.createMany(RepositoryService.QueryService.entities.Project, data.map((c) => new _a(Object.assign(Object.assign({}, c), { uuid: c.uuid || (0, uuid_1.v4)() }))));
...
Project.find = (RepositoryService, options) => __awaiter(void 0, void 0, void 0, function* () {
    const account = yield RepositoryService.findOne(RepositoryService.QueryService.entities.Project, options);
    return account;
});
Project.findAll = (RepositoryService_1, ...args_1) => __awaiter(void 0, [RepositoryService_1, ...args_1], void 0, function* (RepositoryService, options = {}) {
    const projects = yield RepositoryService.findAll(RepositoryService.QueryService.entities.Project, options);
    return projects;
});
