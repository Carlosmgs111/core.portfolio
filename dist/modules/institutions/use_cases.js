...
const addNewInstitution = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const institution = yield entity_1.Institution.create(dependencies_1.RepositoryService, data);
    return institution;
});
exports.addNewInstitution = addNewInstitution;
const getAllInstitutions = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return yield entity_1.Institution.findAll(dependencies_1.RepositoryService, data);
});
exports.getAllInstitutions = getAllInstitutions;
const updateInstitution = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return yield (yield entity_1.Institution.load(dependencies_1.RepositoryService, { uuid: data.uuid })).update(dependencies_1.RepositoryService, data);
});
...
const deleteInstitution = (data) => __awaiter(void 0, void 0, void 0, function* () {
    yield (yield entity_1.Institution.load(dependencies_1.RepositoryService, { uuid: data.uuid })).remove(dependencies_1.RepositoryService, { userUUID: data.user.uuid });
