...
const getMyNotes = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { user } = data;
    console.log({ user });
    const myNotes = (yield User_1.User.find(dependencies_1.RepositoryService, {
...
const createNewNote = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const note = yield Note_1.Note.createOne(dependencies_1.RepositoryService, Object.assign(Object.assign({}, attrs), { userUUID: user.uuid }));
    return note;
});
