...
const config = {
  ...
  mongoDBLocalTestUrl:
    process.env.MONGODB_LOCAL_TEST_URL &&
  ...
  postgresUserDev:
    process.env.POSTGRES_USER_DEV && String(process.env.POSTGRES_USER_DEV),
  postgresPasswordDev:
    process.env.POSTGRES_PASSWORD_DEV &&
    String(process.env.POSTGRES_PASSWORD_DEV),
  postgresHostDev:
    process.env.POSTGRES_HOST_DEV && String(process.env.POSTGRES_HOST_DEV),
  postgresPortDev:
    process.env.POSTGRES_PORT_DEV && String(process.env.POSTGRES_PORT_DEV),
  /*  */
  serverPort: process.env.PORT && String(process.env.PORT),
  jwtAccessSecret:
    process.env.JWT_ACCESS_SECRET && String(process.env.JWT_ACCESS_SECRET),
  jwtSignupSecret:
    process.env.JWT_SIGNUP_SECRET && String(process.env.JWT_SIGNUP_SECRET),
